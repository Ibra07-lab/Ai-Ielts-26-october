...
export namespace ielts {
    ...
    export class ServiceClient {
        ...
        public async deleteHighlight(params: { userId: number, highlightId: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/users/${encodeURIComponent(params.userId)}/reading/highlights/${encodeURIComponent(params.highlightId)}`, {method: "DELETE", body: undefined})
        }
