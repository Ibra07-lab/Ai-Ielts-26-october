          ...
          <div className="sticky top-0 z-40 flex h-16 items-center px-4 sm:px-6 lg:px-8 border-b border-gray-200 bg-white md:bg-white/50 md:backdrop-blur-md shadow-sm dark:border-gray-700 dark:bg-gray-900 md:dark:bg-gray-800/50">
            <div className="flex flex-1 items-center justify-between">
              ...
              <div className="flex items-center justify-end w-1/3 gap-3 lg:gap-5">
                ...
                {/* Feedback Link */}
                <a 
                  href="https://t.me/NewBand0" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-slate-600 hover:text-indigo-600 dark:text-slate-300 dark:hover:text-indigo-400 transition-colors bg-white dark:bg-slate-800 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow active:scale-95"
                >
