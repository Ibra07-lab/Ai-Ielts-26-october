            ...
            >
                    ...
                    <div className="animate-in fade-in duration-300">
                        ...
                        {test.id === 10 ? (
                            ...
                            <div className="border border-black p-6">
                                ...
                                <div className="mt-12 pt-8 border-t border-slate-200">
                                    <div className="mb-4">
                                        <span className="italic text-lg">Questions 16–20</span>
                                    </div>

                                    <p className="italic mb-2">Label the map below.</p>
                                    <p className="italic mb-6">Write the correct letter, <strong>A–H</strong>, next to Questions 16–20.</p>

                                    <h3 className="text-xl font-bold text-center mb-6">Farley House</h3>

                                    <div className="flex flex-col md:flex-row gap-8 items-start">
                                        {/* Map Image */}
                                        <div className="flex-1 w-full relative">
                                            <img
                                                src="/images/test-3-map.png"
                                                alt="Map of Farley House"
                ...
                {activePart === 4 && (
                    <div className="bg-white p-6 animate-in fade-in duration-300">
                        ...
                        {test.id === 11 && (
                            <div className="flex flex-col items-center justify-center p-20 border-2 border-dashed border-slate-200 rounded-2xl bg-slate-50/50">
                                <div className="text-4xl mb-4 font-bold text-slate-300">PART 4</div>
                                <div className="text-slate-500 font-medium text-center">
                                    Questions for Test 11 Part 4 will be added here once available.
                                </div>
                            </div>
                        )}
