              ...
              <Card className="border-purple-100 dark:border-purple-900/50 shadow-sm bg-white dark:bg-slate-900 sticky top-4 z-40 rounded-2xl">
                <CardContent className="py-2 px-4">
                  <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 items-start w-full">
                    {/* Left Column - Audio Play button & Scrubber */}
                    <div className="flex flex-col sm:flex-row flex-1 items-center gap-4 w-full">
                      <div className="flex items-center gap-4 w-full sm:w-auto flex-1">
                        ...
                        <div className="flex-1 flex items-center gap-2 sm:gap-3 bg-slate-50 dark:bg-slate-800/50 px-2 sm:px-3 py-1.5 rounded-lg border border-slate-100 dark:border-slate-800 h-10 min-w-0">
                          <span className="text-[10px] font-mono font-medium text-purple-600 dark:text-purple-400 w-8 shrink-0">{formatTime(currentTime)}</span>

                          <div className="flex-1 flex gap-0.5 h-6 items-end mx-1 overflow-hidden">
                            {[...Array(60)].map((_, i) => (
                              <div
                                key={i}
                          ...
                          <span className="text-[10px] font-mono font-medium text-slate-400 w-8 text-right shrink-0">{formatTime(duration)}</span>
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-2 shrink-0 w-full sm:w-auto mt-2 sm:mt-0">
                        ...
                        <Button
                          ...
                          className="h-8 px-3 text-xs gap-1.5 font-medium text-slate-600 dark:text-slate-300 w-full sm:w-auto"
                        >
                          {showTranscript ? <EyeOff className="h-3.5 w-3.5" /> : <Eye className="h-3.5 w-3.5" />}
                          <span className="inline">Transcript</span>
                        </Button>
                      </div>
                    </div>
                  </div>
                  ...
                  {showTranscript && (transcriptData?.transcripts || transcriptData?.transcript) && (
                    <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-2">
                      <div className="bg-slate-50 dark:bg-slate-800/50 rounded-lg p-3 sm:p-4 max-h-[400px] overflow-y-auto space-y-6">
                          ...
                          <div key={sectionIndex} className="space-y-3">
                            ...
                            <div className="space-y-3">
                              {(section.lines || []).map((line: TranscriptLine, index: number) => {
                                ...
                                return (
                                  <div key={index} className="text-sm leading-relaxed flex flex-col sm:flex-row gap-1 sm:gap-3">
                    ...
                    {!result && (
                      <div className="pt-8 border-t border-slate-100 dark:border-slate-800 flex justify-end">
                        <Button
                          ...
                          className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white shadow-lg px-8 py-6 text-lg rounded-xl transition-transform hover:scale-105"
                        >
                ...
                {result && (
                  <Card className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-800 animate-in slide-in-from-bottom-4 duration-500">
                    ...
                    <CardContent>
                      ...
                      <div className="mt-6 bg-white/70 dark:bg-green-900/20 rounded-xl p-4 overflow-x-auto">
